...
class UserMasterDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.arguments != null) {
          ...
          dropdownValue.value =
              affiliatedOffice.text = controllerStaffUser.staffUserListDetail['affiliatedOffice'].toString();
    ...
    return Obx(() =>
    controllerStaffUser.isLoading.value
        ? const Center(
                ...
                Get.arguments != null
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed: () {
                          Get.toNamed(
                              '/limit-setting', arguments: Get.arguments);
                        },
                        style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(
                                vertical: 20, horizontal: 20),
