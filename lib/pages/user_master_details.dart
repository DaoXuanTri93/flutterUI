...
class UserMasterDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (Get.arguments != null) {
      userAccount.text =
          controllerStaffUser.staffUserListDetail['userAccount'].toString();
      userName.text =
          controllerStaffUser.staffUserListDetail['userName'].toString();
      mail.text = controllerStaffUser.staffUserListDetail['email'].toString();
      phone.text =
          controllerStaffUser.staffUserListDetail['telephone'].toString();
      mac.text = 'MAC : ${controllerStaffUser.staffUserListDetail['mac']}';
      dropdownValue.value = affiliatedOffice.text = controllerStaffUser
          .staffUserListDetail['affiliatedOffice']
          .toString();
